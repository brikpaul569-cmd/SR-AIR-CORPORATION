        ...
        <div className="footer__cta">
          <div className="footer__cta-group">
            ...
            <a href="https://wa.me/17206804049" target="_blank" rel="noopener noreferrer"
               className="footer__ac-btn" aria-label={t('footer.whatsapp')} title={t('footer.whatsapp')}>
              <span className="footer__ac-coil">
                <span className="footer__ac-fan">
                  <span className="footer__ac-wa-icon">
